...
def saveBuild(path, graph, lib, params):
    cc = "/home/a0869574/ti/processor-sdk-linux-am57xx-evm-06.02.00.81-GA/linux-devkit/sysroots/x86_64-arago-linux/usr/bin/arm-linux-gnueabihf-g++"
...
def _main():
    ...
    input_data = test_tidl.get_input_nchw(input_shape)
    test_tidl.model_compile('d3_model', mod, params, {input_name:input_data})
